...
type PurchaseReportsToBankDetail struct {
	...
	IDPurchaseReportsToBank int  `gorm:"int" json:"id_purchase_reports_to_bank" validate:"required"`
	IDPurchaseIgm           int  `gorm:"int" json:"id_purchase_igm" validate:"required"`
